...
void HAL_LTDC_MspInit(LTDC_HandleTypeDef* hltdc)
{
  ...
  /** Initializes the peripherals clock
  */
    /* LTDC pixel clock for the RK043FN48H panel.
     * PLL3 in: HSE(25MHz)/M5 = 5MHz; VCO: 5MHz*N160 = 800MHz; R83 -> ~9.64MHz.
     * (Corrected from the generic CubeMX board-template default, which gave an
     *  unusable ~75MHz pixel clock. Values match ST's STM32H750B-DK BSP.) */
